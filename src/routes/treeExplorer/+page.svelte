...
<main>
		...
		<div id="mixed-attributes" class="gone">
			...
			<div>
				...
				<label class="sort-checkbox"
					><input
						type="checkbox"
						name="sort-information-gain"
						id="sort-information-gain"
						checked
					/>Information gain</label
				>
				|
				<label class="sort-checkbox"
					><input type="checkbox" name="sort-total-classes" id="sort-total-classes" />Total classes</label
				>
				|
				<label class="sort-checkbox"
					><input type="checkbox" name="sort-positive" id="sort-positive" />Positive</label
				>
				|
				<label class="sort-checkbox"
					><input
						type="checkbox"
						name="sort-positive-majority"
						id="sort-positive-majority"
					/>Positive majority</label
				>
				|
				<label class="sort-checkbox"
					><input type="checkbox" name="sort-negative" id="sort-negative" />Negative</label
				>
				|
				<label class="sort-checkbox"
					><input
						type="checkbox"
						name="sort-negative-majority"
						id="sort-negative-majority"
					/>Negative majority</label
				>
				|
				<label class="sort-checkbox"
					><input
	...
	<div id="leaf-info" class="main-panel fira-mono gone">
		...
		<div>
			...
			<div style="clear: both;" />
			<span class="inline-button" onclick="openTreeAttractor();" style="float: right;"
				>Attractor</span
			>
		</div>
	...
	<div id="transparency-switch" class="grey gone">
		<span
			id="mass-distribution-label"
			style="display: table-cell; height: 22px; vertical-align: middle; padding-right: 8px;"
			>Show mass distribution</span
		>
